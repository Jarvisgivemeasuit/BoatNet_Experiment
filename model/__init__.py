...
def save_model(model1, model2=None, model_name, backbone1, backbone2=None, annotations):
    save_path = '/home/arron/Documents/grey/paper/model_saving/'
    if backbone2 is None or model2 is None:
        torch.save(model, os.path.join(save_path, "{}-{}-{}bast_pred.pth".format(backbone1, model_name, annotations)))
    else:
